---
title: Kopi Luwak Internet Theory
author: Justin Taylor
pubDatetime: 2025-12-10T22:20:53.429Z
slug: "kopi-luwak-internet-theory"
description: "A reasonable and moderate take on generative AI and its effects on humanity"
draft: false
tags:
...
Even our evening meals aren’t safe from this toxic surge. Recipe bloggers have seen up to an 80% drop in traffic since the rise of LLMs [^slop-recipes]. The odds are good that the slop recipes surging through social media don’t produce anything edible. After all, they lack the one thing that recipe blogs and books were actually selling - the assurance that a human might have actually cooked the fucking food in the first place.
...
It’s not just the participant’s reported depth of learning. The study asked participants to write a piece using what they’d learned. The result? “*…content of advice written after searching through ChatGPT (vs. Google) contained linguistic markers suggestive of shallower learning.*[^web-search].  
...
It used not only the essays written by participants, but EEG scans as well to examine this effect. The final conclusion was bleak to say the least - *“Over four months, LLM users consistently underperformed at neural, linguistic, and behavioral levels.”* [^learning]. 
...
### References
[^web-search]: Shiri Melumad and Yun, J.H. (2025). Experimental evidence of the effects of large language models versus web search on depth of learning. *PNAS Nexus*, [online] 4(10), pp.pgaf316–pgaf316. doi:https://doi.org/10.1093/pnasnexus/pgaf316.

[^learning]: Nataliya Kos'myna (2025). *Your Brain on ChatGPT: Accumulation of Cognitive Debt when Using an AI Assistant for Essay Writing Task – MIT Media Lab*. [online] MIT Media Lab. Available at: https://www.media.mit.edu/publications/your-brain-on-chatgpt/.

[^slop-recipes]: Alba, D. and Arroyo, C. (2025). *AI Slop Recipes Are Taking Over the Internet — And Thanksgiving Dinner*. [online] Bloomberg.com. Available at: https://www.bloomberg.com/news/articles/2025-11-25/ai-slop-recipes-are-taking-over-the-internet-and-thanksgiving-dinner [Accessed 5 Dec. 2025].
